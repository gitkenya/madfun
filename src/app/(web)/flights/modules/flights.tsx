    ...
    <div className="w-full max-w-[75rem] hidden sm:flex flex-col gap-4">
      ...
      <div className="flex flex-col rounded-lg shadow-lg">
        ...
        <div className="bg-slate-100 rounded-b-lg flex flex-row justify-between">
          ...
          <div>
            <button className="transition-colors duration-300 bg-slate-900 hover:bg-slate-700 text-white px-8 py-3 h-full rounded-br flex flex-row items-center gap-4 font-poppins text-sm">
