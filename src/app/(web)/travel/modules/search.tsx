...
export default function SearchForm() {
  ...
  return (
    <div className="w-full hidden sm:flex flex-col gap-6">
      ...
      <div className="grid grid-cols-3 p-4 rounded-lg bg-white">
        <div className="flex flex-row items-center border-r border-slate-200">
          <Select
            ...
            classNames={{
              ...
              menu: () =>
                "p-1 -ms-4 mt-2 border w-full min-w-[200px] left-0  border-slate-200 text-slate-800 bg-white rounded-lg py-3 px-4 focus:outline-none",
        ...
        <div className="flex flex-row items-center justify-end">
          <button className="transition-all duration-300 sm:min-w-[120px] bg-slate-800 hover:bg-slate-950 text-white rounded-lg px-4 py-3 text-center">
            Search
          </button>
        </div>
      </div>
