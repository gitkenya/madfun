        ...
        <div className="w-full sm:w-2/3 flex flex-col gap-4 sm:gap-6">
          ...
          <div className="w-full grid grid-cols-2 sm:grid-cols-3 gap-3">
            <div
              ...
              style={{
                backgroundImage: `url(/assets/img/blog/capetown/capetown-1.jpg)`,
              }}
            ></div>
            <div
              className="w-full aspect-video bg-cover bg-center rounded-xl sm:rounded-xl"
              style={{
                backgroundImage: `url(/assets/img/blog/capetown/capetown-2.jpg)`,
              }}
            ></div>
            <div
              className="w-full aspect-video bg-cover bg-center rounded-xl sm:rounded-xl"
              style={{
                backgroundImage: `url(/assets/img/blog/capetown/capetown-3.jpg)`,
              }}
            ></div>
          </div>
        </div>
