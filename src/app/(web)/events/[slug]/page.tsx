            ...
            <div className="p-4 md:p-12 flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-4">
                ...
                <p className="border-b border-slate-200 pb-4">
                  ...
                  thing in the world worth living for. Dancan MacMillian's play
                  Every Brilliant thing pulls back the curtain on what it's like
                  a child of a suicidal mother nd the lengths we go for those we
                  love. Based on true and untrue stories, Every Brilliant thing
                  in a life-affirming story of how to achieve hope through
                  focusing on the smallest miracles in life.
                </p>
