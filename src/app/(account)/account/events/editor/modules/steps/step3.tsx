          ...
          <div className="flex flex-col items-center justify-center">
            <div className="w-full  bg-slate-100 dark:bg-slate-700 rounded-lg flex flex-col items-center justify-center gap-5 py-6 sm:py-16">
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <button className="transition-all duration-300 mt-4 flex flex-row items-center gap-2 px-6 py-2 rounded-lg border border-slate-700 text-slate-700 dark:border-slate-400 dark:text-slate-400 hover:bg-slate-800 hover:text-white">
